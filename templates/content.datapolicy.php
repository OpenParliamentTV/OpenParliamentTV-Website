<head>
	...
	<title>Open Parliament TV - <?php echo L::dataPolicy; ?></title>
	...
	<main class="container subpage">
		<div class="row m-0" style="position: relative; z-index: 1">
			<div class="col-lg-10 mx-auto">
				<h2><?php echo L::dataPolicy; ?> (DE)</h2>
				...
				<h4>2.1. Übermittlung im Rahmen der [ABGEORDNETENWATCH, BUNDESTAG, VIDEODIENSTLEISTER]</h4>
				<p>[BESCHREIBUNG (noch nicht relevant)]</p>
				...
				<hr>
				<p>Wenn Sie Fragen haben, die Ihnen diese Datenschutzerklärung nicht beantworten konnte oder wenn Sie zu einem Punkt vertiefte Informationen wünschen, wenden Sie sich bitte jederzeit an&nbsp;<b>joscha.jaeger [at] openparliament.tv</b>.</p>
				<hr>
				<h3>5. Sicherheitshinweis</h3>
				<p>Wir weisen darauf hin, dass die Datenübertragung im Internet (z.B. bei der Kommunikation per E-Mail) Sicherheitslücken aufweisen kann. Ein lückenloser Schutz der Daten vor dem Zugriff durch Dritte ist nicht möglich.</p>
				<hr>
				<p>Stand 4. Juni 2020</p>
			</div>
		</div>
	</main>
