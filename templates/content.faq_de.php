			...
			<div class="col-12">
				<div class="card mb-4" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="card-header" id="q1">
						<h3 itemprop="name">Wer steht hinter Open Parliament TV?</h3>
					</div>
					<div id="a1" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
						<div class="card-body" itemprop="text">Mehr Informationen zu den Menschen hinter dem Projekt finden sich unter: <a href="team">Team</a>. <br>Organisatorisch sind wir in das <a href="https://techcultivation.org" target="_blank">Center for the Cultivation of Technology (CCT)</a> eingebettet, einer Host Organisation für gemeinnützige Open Source Projekte. <br><br>Mehr unter der Frage: <i>Wie finanziert ihr euch?</i></div>
					</div>
				</div>
				<div class="card mb-4" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="card-header" id="q2">
						<h3 itemprop="name">Arbeitet ihr mit Parlamenten zusammen?</h3>
					</div>
				...
				<div class="card mb-4" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="card-header" id="q3">
						<h3 itemprop="name">Woher bekommt ihr die Videos?</h3>
					</div>
				...
				<div class="card mb-4" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="card-header" id="q4">
						<h3 itemprop="name">Woher bekommt ihr die Protokolle und Daten?</h3>
					</div>
					<div id="a4" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
						<div class="card-body" itemprop="text">Seit Beginn der 18. Wahlperiode (Oktober 2013) sind die Plenarprotokolle des Bundestages in einem <a href="https://www.bundestag.de/services/opendata" target="_blank">maschinenlesbaren „Open Data“ Format</a> verfügbar. Wir arbeiten für andere Parlamente daran, diese Informationen auch automatisiert aus Plenarprotokollen in PDF-Form auszulesen. In einer perfekten Welt würden jedoch alle Parlamente ihre Dokumente in maschinenlesbaren, international standardisierten Formaten veröffentlichen (diese Standards existieren, sie werden nur nicht genutzt). <br><br>Die Stenografischen Berichte / Plenarprotokolle des Deutschen Bundestages sind als amtliche Dokumente gemeinfrei. <br><br>Die Daten zu den Personen, Fraktionen und Parteien beziehen wir von <a href="https://www.wikidata.org/" target="_blank">Wikidata</a> (einer freien Wissensdatenbank, die jede und jeder bearbeiten kann). Die Daten zu Drucksachen des Deutschen Bundestages fragen wir über die "<a href="https://dip.bundestag.de/%C3%BCber-dip/hilfe/api" target="_blank">DIP API</a>" ab. </div>
					</div>
				</div>
				<div class="card mb-4" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="card-header" id="q5">
						<h3 itemprop="name">Wie synchronisiert ihr die Videos mit den Protokollen?</h3>
					</div>
				...
				<div class="card mb-4" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="card-header" id="q6">
						<h3 itemprop="name">Warum sind manche Texte nicht synchronisiert?</h3>
					</div>
				...
				<div class="card mb-4" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="card-header" id="q7">
						<h3 itemprop="name">Warum gibt es für manche Reden keine Texte?</h3>
					</div>
				...
				<div class="card mb-4" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="card-header" id="q8">
						<h3 itemprop="name">Warum stimmt der Text nicht exakt mit dem gesprochenen Wort überein?</h3>
					</div>
				...
				<div class="card mb-4" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="card-header" id="q9">
						<h3 itemprop="name">Warum machen das nicht die Mediatheken der Parlamente?</h3>
					</div>
				...
				<div class="card mb-4" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
					<div class="card-header" id="q12">
						<h3 itemprop="name">Wann ist mein Parlament bei euch zu finden?</h3>
					</div>
